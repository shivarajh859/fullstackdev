...
public class ReadSheet1FirstColWriteSheet2FirstCol {
	...
	private static void readContent() {
		...
		try {
			fin = new FileInputStream("C:\\Users\\ADE174\\Downloads\\ExcelAssignment\\Fruits.xlsx");
			...
			fout = new FileOutputStream("C:\\Users\\ADE174\\Downloads\\ExcelAssignment\\Fruits.xlsx");
			wb.write(fout);
